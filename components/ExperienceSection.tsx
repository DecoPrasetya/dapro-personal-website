    ...
    <section className="py-32 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        {personalData.experience.map((exp, i) => (
          ...
          >
            <h3 className="text-2xl font-semibold text-violet-400 mb-2">
              {exp.title}
            </h3>
            <p className="text-gray-400 text-sm mb-4">{exp.subtitle}</p>
            ...
            {exp.role && (
              <p className="mt-4 text-indigo-300 text-sm italic">
                🧭 {exp.role}
              </p>
            )}
          </motion.div>
