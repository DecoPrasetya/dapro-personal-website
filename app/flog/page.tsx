      ...
      <div className="max-w-7xl mx-auto">
        ...
        {flogs.length > 0 ? (
          <div className="flex flex-col gap-10 max-w-4xl mx-auto">
            {flogs.map((flog: any) => (
              <div key={flog.id} className="flex flex-col md:flex-row bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden hover:bg-white/10 transition-all duration-300">
